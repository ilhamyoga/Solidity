...
/**
   ...
   3% fee auto moved to burned supply
...
contract NFTGIFT is Context, IBEP20, Ownable {
  ...
  constructor() public {
    ...
    _tTotal = 1000000000000000 * 10**9; // this total supply 1T
  ...
  */
  ...
  function _tokenFeeBurn(uint256 tBurn) private {
    uint256 currentRate = _getRate();
    uint256 rBurn = tBurn.mul(currentRate);
    _rTotal = _rTotal.sub(rBurn);
    _rOwned[owner()] = _rOwned[owner()].sub(tBurn, "BEP20: burn amount exceeds balance");
